...
public class EntryModificationTests  extends TestBase {
    ...
    public void testEntryModification() {
        ...
        app.getEntryHelper().fillEntryForm(new EntryData("Ivan", "Aleksandrovich", "Petrov", "vanko", "title", "comp", "блаблабла очень длинный адрес 23", "123345", "123156496879", "wqer@qwe.ru", "16", "September", "1980"));
